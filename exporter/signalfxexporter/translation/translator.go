...
const (
	...
	// ActionDropMetrics drops datapoints with metric name defined in "metric_filters".
...
type MetricTranslator struct {
	...
	// Map from index of a Rule to the corresponding dpFilters.FilterSet, in case the rule
	// is associated with a drop_metrics action.
